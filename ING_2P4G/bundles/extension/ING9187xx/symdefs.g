...
uuid128_to_str = 0x00022965;
uuid_add_bluetooth_prefix = 0x000229bd;
uuid_has_bluetooth_prefix = 0x000229dd;
uxListRemove = 0x000229f9;
uxQueueMessagesWaiting = 0x00022a21;
uxQueueMessagesWaitingFromISR = 0x00022a49;
uxQueueSpacesAvailable = 0x00022a65;
uxTaskGetStackHighWaterMark = 0x00022a91;
uxTaskPriorityGet = 0x00022ab1;
uxTaskPriorityGetFromISR = 0x00022acd;
vListInitialise = 0x00022b87;
vListInitialiseItem = 0x00022b9d;
vListInsert = 0x00022ba3;
vListInsertEnd = 0x00022bd3;
vPortEndScheduler = 0x00022bed;
vPortEnterCritical = 0x00022c19;
vPortExitCritical = 0x00022c5d;
vPortFree = 0x00022c91;
vPortSuppressTicksAndSleep = 0x00022d25;
vPortValidateInterruptPriority = 0x00022e4d;
vQueueDelete = 0x00022ea9;
vQueueWaitForMessageRestricted = 0x00022ed5;
vTaskDelay = 0x00022f1d;
vTaskInternalSetTimeOutState = 0x00022f69;
vTaskMissedYield = 0x00022f79;
vTaskPlaceOnEventList = 0x00022f85;
vTaskPlaceOnEventListRestricted = 0x00022fbd;
vTaskPriorityDisinheritAfterTimeout = 0x00022ffd;
vTaskPrioritySet = 0x000230a9;
vTaskResume = 0x00023171;
vTaskStartScheduler = 0x000231f5;
vTaskStepTick = 0x00023285;
vTaskSuspend = 0x000232b5;
vTaskSuspendAll = 0x00023371;
vTaskSwitchContext = 0x00023381;
xPortStartScheduler = 0x00023429;
xQueueAddToSet = 0x000234f1;
xQueueCreateCountingSemaphore = 0x00023515;
xQueueCreateCountingSemaphoreStatic = 0x00023551;
xQueueCreateMutex = 0x00023595;
xQueueCreateMutexStatic = 0x000235ab;
xQueueCreateSet = 0x000235c5;
xQueueGenericCreate = 0x000235cd;
xQueueGenericCreateStatic = 0x00023619;
xQueueGenericReset = 0x00023681;
xQueueGenericSend = 0x0002370d;
xQueueGenericSendFromISR = 0x00023879;
xQueueGiveFromISR = 0x00023939;
xQueueGiveMutexRecursive = 0x000239dd;
xQueueIsQueueEmptyFromISR = 0x00023a1d;
xQueueIsQueueFullFromISR = 0x00023a41;
xQueuePeek = 0x00023a69;
xQueuePeekFromISR = 0x00023b91;
xQueueReceive = 0x00023bfd;
xQueueReceiveFromISR = 0x00023d29;
xQueueRemoveFromSet = 0x00023dbd;
xQueueSelectFromSet = 0x00023ddf;
xQueueSelectFromSetFromISR = 0x00023df1;
xQueueSemaphoreTake = 0x00023e05;
xQueueTakeMutexRecursive = 0x00023f71;
xTaskCheckForTimeOut = 0x00023fb5;
xTaskCreate = 0x00024025;
xTaskCreateStatic = 0x00024081;
xTaskGetCurrentTaskHandle = 0x000240f1;
xTaskGetSchedulerState = 0x000240fd;
xTaskGetTickCount = 0x00024119;
xTaskGetTickCountFromISR = 0x00024125;
xTaskIncrementTick = 0x00024135;
xTaskPriorityDisinherit = 0x00024201;
xTaskPriorityInherit = 0x00024295;
xTaskRemoveFromEventList = 0x00024329;
xTaskResumeAll = 0x000243a9;
xTaskResumeFromISR = 0x00024471;
xTimerCreate = 0x000244fd;
xTimerCreateStatic = 0x00024531;
xTimerCreateTimerTask = 0x00024569;
xTimerGenericCommand = 0x000245d5;
xTimerGetExpiryTime = 0x00024645;
xTimerGetTimerDaemonTaskHandle = 0x00024665;
