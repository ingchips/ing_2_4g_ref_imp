...
#define PULSE_TEST_GPIO1     GIO_GPIO_18
#define PULSE_TEST_GPIO2     GIO_GPIO_19
#define PULSE_TEST_GPIO3     GIO_GPIO_20
#define PULSE_TEST_GPIO4     GIO_GPIO_21
#define PULSE_TEST_GPIO5     GIO_GPIO_22
#define PULSE_TEST_GPIO6     GIO_GPIO_23
