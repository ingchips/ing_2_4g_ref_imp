...
#define ADV_INTERNAL 500000

static platform_us_timer_handle_t app_2g4_test_handle;
...
static void *master_2g4_tx_ustimer_cb(platform_us_timer_handle_t timer_handle, uint64_t time_us, void *param) 
{
    ...
    else
    {
		...
		ing2g4_tx_data[0]++;
		ing2g4_tx_data[0] = ing2g4_tx_data[0] % 4;
    }
	app_2g4_test_handle = platform_create_us_timer((platform_get_us_time() + ADV_INTERNAL), master_2g4_tx_ustimer_cb, NULL);
    return 0;
}
