...
eTaskConfirmSleepModeStatus = 0x00006db5;
gap_add_dev_to_periodic_list = 0x00007385;
gap_add_whitelist = 0x00007395;
gap_aes_encrypt = 0x000073a1;
gap_clear_white_lists = 0x000073d9;
gap_clr_adv_set = 0x000073e5;
gap_clr_periodic_adv_list = 0x000073f1;
gap_create_connection_cancel = 0x000073fd;
gap_disconnect = 0x00007409;
gap_disconnect2 = 0x00007411;
gap_disconnect_all = 0x0000743d;
gap_ext_create_connection = 0x0000747d;
gap_get_connection_parameter_range = 0x00007555;
gap_le_read_channel_map = 0x0000758d;
gap_periodic_adv_create_sync = 0x000075ed;
gap_periodic_adv_create_sync_cancel = 0x00007611;
gap_periodic_adv_term_sync = 0x0000761d;
...
gap_read_white_lists_size = 0x000076e1;
gap_remove_whitelist = 0x000076ed;
gap_rmv_adv_set = 0x00007769;
gap_rmv_dev_from_periodic_list = 0x00007775;
gap_rx_test_v2 = 0x00007785;
gap_set_adv_set_random_addr = 0x000077bd;
gap_set_callback_for_next_hci = 0x000077e1;
gap_set_connection_parameter_range = 0x00007801;
gap_set_data_length = 0x00007819;
gap_set_def_phy = 0x00007831;
gap_set_ext_adv_data = 0x00007841;
gap_set_ext_adv_enable = 0x00007859;
gap_set_ext_adv_para = 0x000078c9;
gap_set_ext_scan_enable = 0x00007991;
gap_set_ext_scan_para = 0x000079a9;
gap_set_ext_scan_response_data = 0x00007a49;
gap_set_host_channel_classification = 0x00007a61;
gap_set_periodic_adv_data = 0x00007a71;
gap_set_periodic_adv_enable = 0x00007ae1;
gap_set_periodic_adv_para = 0x00007af1;
gap_set_phy = 0x00007b09;
gap_set_random_device_address = 0x00007b25;
gap_start_ccm = 0x00007b41;
gap_test_end = 0x00007b89;
gap_tx_test_v2 = 0x00007b95;
gap_tx_test_v4 = 0x00007bad;
gap_update_connection_parameters = 0x00007bd1;
gap_vendor_tx_continuous_wave = 0x00007c15;
gatt_client_cancel_write = 0x0000813d;
gatt_client_discover_characteristic_descriptors = 0x00008163;
gatt_client_discover_characteristics_for_handle_range_by_uuid128 = 0x000081a3;
gatt_client_discover_characteristics_for_handle_range_by_uuid16 = 0x000081f3;
gatt_client_discover_characteristics_for_service = 0x00008243;
gatt_client_discover_primary_services = 0x00008279;
gatt_client_discover_primary_services_by_uuid128 = 0x000082ab;
gatt_client_discover_primary_services_by_uuid16 = 0x000082ef;
gatt_client_execute_write = 0x0000832b;
gatt_client_find_included_services_for_service = 0x00008351;
gatt_client_get_mtu = 0x0000837f;
gatt_client_is_ready = 0x00008429;
gatt_client_listen_for_characteristic_value_updates = 0x0000843f;
gatt_client_prepare_write = 0x00008461;
gatt_client_read_characteristic_descriptor_using_descriptor_handle = 0x0000849d;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle = 0x000084c7;
gatt_client_read_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x000084cd;
gatt_client_read_long_value_of_characteristic_using_value_handle = 0x000084fb;
gatt_client_read_long_value_of_characteristic_using_value_handle_with_offset = 0x00008501;
gatt_client_read_multiple_characteristic_values = 0x0000852f;
gatt_client_read_value_of_characteristic_using_value_handle = 0x0000855f;
gatt_client_read_value_of_characteristics_by_uuid128 = 0x0000858d;
gatt_client_read_value_of_characteristics_by_uuid16 = 0x000085d9;
gatt_client_register_handler = 0x00008625;
gatt_client_reliable_write_long_value_of_characteristic = 0x00008631;
gatt_client_signed_write_without_response = 0x00008a61;
gatt_client_write_characteristic_descriptor_using_descriptor_handle = 0x00008b25;
gatt_client_write_client_characteristic_configuration = 0x00008b5f;
gatt_client_write_long_characteristic_descriptor_using_descriptor_handle = 0x00008bb1;
gatt_client_write_long_characteristic_descriptor_using_descriptor_handle_with_offset = 0x00008bc1;
gatt_client_write_long_value_of_characteristic = 0x00008bfd;
gatt_client_write_long_value_of_characteristic_with_offset = 0x00008c0d;
gatt_client_write_value_of_characteristic = 0x00008c49;
gatt_client_write_value_of_characteristic_without_response = 0x00008c7f;
hci_add_event_handler = 0x0000a19d;
hci_power_control = 0x0000a939;
hci_register_acl_packet_handler = 0x0000aaed;
kv_commit = 0x0000b231;
kv_get = 0x0000b28d;
kv_init = 0x0000b299;
kv_init_backend = 0x0000b319;
kv_put = 0x0000b32d;
kv_remove = 0x0000b339;
kv_remove_all = 0x0000b36d;
kv_value_modified = 0x0000b39d;
kv_value_modified_of_key = 0x0000b3b9;
kv_visit = 0x0000b3c5;
l2cap_add_event_handler = 0x0000b455;
l2cap_can_send_packet_now = 0x0000b465;
l2cap_create_le_credit_based_connection_request = 0x0000b621;
l2cap_credit_based_send = 0x0000b765;
l2cap_credit_based_send_continue = 0x0000b791;
l2cap_disconnect = 0x0000b80d;
l2cap_get_le_credit_based_connection_credits = 0x0000ba55;
l2cap_get_peer_mtu_for_local_cid = 0x0000ba71;
l2cap_init = 0x0000be31;
l2cap_le_send_flow_control_credit = 0x0000bf25;
l2cap_max_le_mtu = 0x0000c221;
l2cap_register_packet_handler = 0x0000c349;
l2cap_register_service = 0x0000c355;
l2cap_request_can_send_now_event = 0x0000c465;
l2cap_request_connection_parameter_update = 0x0000c47f;
l2cap_send_echo_request = 0x0000c94d;
l2cap_unregister_service = 0x0000ca0d;
le_device_db_add = 0x0000ca65;
le_device_db_find = 0x0000cb3d;
le_device_db_from_key = 0x0000cb69;
le_device_db_iter_cur = 0x0000cb71;
le_device_db_iter_cur_key = 0x0000cb75;
le_device_db_iter_init = 0x0000cb79;
le_device_db_iter_next = 0x0000cb81;
le_device_db_remove_key = 0x0000cba7;
ll_ackable_packet_alloc = 0x0000cbd3;
ll_ackable_packet_get_status = 0x0000cd05;
ll_ackable_packet_run = 0x0000cd75;
ll_ackable_packet_set_tx_data = 0x0000ce11;
ll_aes_encrypt = 0x0000ce2d;
ll_channel_monitor_alloc = 0x0000cea9;
ll_channel_monitor_check_each_pdu = 0x0000cf2b;
ll_channel_monitor_run = 0x0000cf99;
ll_config = 0x0000d04d;
ll_free = 0x0000d083;
ll_get_capabilities = 0x0000d08d;
ll_get_heap_free_size = 0x0000d0ad;
ll_get_states = 0x0000d0bd;
ll_hint_on_ce_len = 0x0000d179;
ll_legacy_adv_set_interval = 0x0000d1b1;
ll_lock_frequency = 0x0000d1c1;
ll_malloc = 0x0000d225;
ll_query_timing_info = 0x0000d35d;
ll_raw_packet_alloc = 0x0000d3a9;
ll_raw_packet_free = 0x0000d47d;
ll_raw_packet_get_bare_rx_data = 0x0000d4b5;
ll_raw_packet_get_rx_data = 0x0000d57b;
ll_raw_packet_recv = 0x0000d61d;
ll_raw_packet_send = 0x0000d6d9;
ll_raw_packet_set_bare_data = 0x0000d7c1;
ll_raw_packet_set_bare_mode = 0x0000d7ff;
ll_raw_packet_set_param = 0x0000d905;
ll_raw_packet_set_tx_data = 0x0000d963;
ll_register_hci_acl_previewer = 0x0000d9c9;
ll_scan_set_fixed_channel = 0x0000da2d;
ll_set_adv_access_address = 0x0000dc45;
ll_set_adv_coded_scheme = 0x0000dc51;
ll_set_conn_acl_report_latency = 0x0000dc81;
ll_set_conn_coded_scheme = 0x0000dcb1;
ll_set_conn_interval_unit = 0x0000dcdd;
ll_set_conn_latency = 0x0000dce9;
ll_set_conn_tx_power = 0x0000dd19;
ll_set_def_antenna = 0x0000dd61;
